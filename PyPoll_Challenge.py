...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (c_votes > largest_turnout_count) and (c_vote_percentage > largest_turnout_percentage):
            largest_turnout_count = c_votes
            largest_turnout_county = county_name
            largest_turnout_percentage = c_vote_percentage
